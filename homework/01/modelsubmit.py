...
flags.DEFINE_string('save_dir', '/work/cse496dl/vsunkara/homework01', 'directory where model graph and weights are saved')
...
def main(argv):
    ...
    with tf.name_scope('linear_model') as scope:
        ...
        hidden1 = tf.layers.dense(dropped_input, NEURONS_HIDDEN1,activation=tf.nn.relu, name='hidden_layer1')
        dropped_hidden1 = tf.layers.dropout(hidden1, KEEP_PROB)
        hidden2 = tf.layers.dense(dropped_hidden1, NEURONS_HIDDEN2,activation = tf.nn.relu,name = 'hidden_layer2')
        ...
        output = tf.layers.dense(dropped_hidden3, 10, name='output_layer')
